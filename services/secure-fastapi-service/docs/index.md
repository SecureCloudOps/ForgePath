...
This is ForgePath's single reference service. It demonstrates the complete v1
path from a Backstage catalog entry and TechDocs through a hardened Helm
workload, policy gates, a trusted image digest, Argo CD reconciliation, Kyverno
admission, and read-only runtime status.
